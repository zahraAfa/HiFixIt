...
class TechBookingInfoPage extends StatefulWidget {
  const TechBookingInfoPage({
    Key? key,
  ...
  @override
  State<TechBookingInfoPage> createState() => _TechBookingInfoPageState();
}

class _TechBookingInfoPageState extends State<TechBookingInfoPage> {
  @override
