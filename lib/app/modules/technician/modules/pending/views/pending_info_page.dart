...
class PendingBookingInfoPage extends StatefulWidget {
  const PendingBookingInfoPage({
    Key? key,
  ...
  @override
  State<PendingBookingInfoPage> createState() => _PendingBookingInfoPageState();
}

class _PendingBookingInfoPageState extends State<PendingBookingInfoPage> {
  @override
