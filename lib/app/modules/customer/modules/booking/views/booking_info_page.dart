...
class CustBookingInfoPage extends StatefulWidget {
  const CustBookingInfoPage({
    Key? key,
  ...
  @override
  State<CustBookingInfoPage> createState() => _CustBookingInfoPageState();
}

class _CustBookingInfoPageState extends State<CustBookingInfoPage> {
  @override
