  ...
  filteringCategory() {
    ...
    switch (selectedCategoryType) {
      case "Washing Machine":
        filCategory = ["Washing Machine"];
        break;
      case "Air Conditioner":
        filCategory = ["Air Conditioner"];
        break;
      default:
        filCategory = ["Washing Machine", "Air Conditioner"];
        break;
    }
  }
          ...
          Positioned(
            ...
            child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where("techCategory", whereIn: filCategory)
                    .orderBy("serviceFee", descending: filPrice)
